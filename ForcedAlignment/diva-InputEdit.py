...
#ProMatrix = np.loadtxt("../ocropy-master/diva-Recognition/Network.txt", skiprows=0)
print (ProMatrix[1:].shape)
print (ProMatrix[0:1].shape)
ProMatrix = np.concatenate((ProMatrix[1:],ProMatrix[0:1]),axis=0)
print 'The probability matrix:', ProMatrix  

# read characters
file = open("charset-defaut.txt", "r")
